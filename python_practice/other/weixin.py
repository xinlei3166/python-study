...
'''
    写一个程序 检测微信好友是否删除自己
    该os, urllib, re, urllib2, cookielib, http.cookiejar, time, json
    xml.dom.minidom, sys, math
'''
...
date = int(time.time())
# QRImagePath = os.getcwd() + '/qrcode' + '_' + str(date) + '.jpg'
...
def webwxinit():
    ...
    # request = urllib.request.Request(url=url, data=bytes(data))
