...
登录请求数据: username=15516444185&password=40205316047&c_add=1
请求方式: POST
登录成功之后 cookies身份认证
NO cookie身份证
ajax 异步加载
...
username = '15516444185'
password = '40205316047'
params = {
          'username': '15516444185',
          'password': '40205316047',
          'c_add': '1',
...
def login():
    ...
    # html = urllib.request.urlopen(url='http://www.ks5u.com/user/inc/UserLogin_Index.asp', data='username=15516444185&password=40205316047&c_add=1').read()
